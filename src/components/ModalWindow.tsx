...
const ModalWindow: React.FC<ModalWindowPropsType> = ({modalType, titleNode, textNode, refId, modalWindowId}) => {
    ...
    const onDiscardClickHandler = () => {
        modalType === 'edit' ? alert('Cancel in Edit mode') : dispatch(setCreateNoteModalShow({isModalShow:false})) //need to fix
    }

    {
        if (modalType === 'edit') {
            return (
                <>
                    <input type="checkbox" id={modalWindowId} className="modal-toggle"/>
                    <div className="modal">
                        <div className="modal-box">
                            ...
                            <div className="modal-action">
                                <label htmlFor={modalWindowId} className="btn"
                                       onClick={onConfirmClickHandler}>Save</label>
                                <label htmlFor={modalWindowId} className="btn"
                                       onClick={onDiscardClickHandler}>Cancel</label>
                            </div>
                        </div>
                    </div>
                </>
